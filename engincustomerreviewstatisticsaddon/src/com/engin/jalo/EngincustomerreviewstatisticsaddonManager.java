...
import com.engin.constants.EngincustomerreviewstatisticsaddonConstants;



/**
 * This is the extension manager of the Engincustomerreviewstatisticsaddon extension.
 */
public class EngincustomerreviewstatisticsaddonManager extends GeneratedEngincustomerreviewstatisticsaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EngincustomerreviewstatisticsaddonManager.class.getName());
	 ...
	 */
	public static EngincustomerreviewstatisticsaddonManager getInstance()
	{
		return (EngincustomerreviewstatisticsaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EngincustomerreviewstatisticsaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EngincustomerreviewstatisticsaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EngincustomerreviewstatisticsaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EngincustomerreviewstatisticsaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EngincustomerreviewstatisticsaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
